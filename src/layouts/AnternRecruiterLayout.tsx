...
const navItems: NavItem[] = [
  { title: "Dashboard", href: "/dashboard/antern-recruiter", icon: LayoutDashboard },
  { title: "All Postings", href: "/dashboard/antern-recruiter/postings", icon: FileText },
  { title: "Post JOB", href: "/dashboard/antern-recruiter/post-job", icon: Building },
  { title: "Company Panels", href: "/dashboard/antern-recruiter/company-panels", icon: Building2 },
  { title: "Designation", href: "/dashboard/antern-recruiter/designation", icon: Briefcase },
  { title: "All Profiles", href: "/dashboard/antern-recruiter/all-profiles", icon: Users },
  { title: "Domain", href: "/dashboard/antern-recruiter/domain", icon: Globe },
];
...
export default function AnternRecruiterLayout() {
  const [sidebarOpen, setSidebarOpen] = useState(false);
  const [companyLogo, setCompanyLogo] = useState("https://upload.wikimedia.org/wikipedia/commons/8/8e/Nextjs-logo.svg");
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="relative h-16 bg-white border-b border-border/50 flex items-center justify-between px-4 sm:px-6 z-40 shrink-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold font-heading hidden sm:block">Antern Recruiter Workspace</h1>
          </div>
                ...
                {profileDropdownOpen && (
                  <>
                    ...
                    >
                      <div className="py-2">
                        <Link 
                          to="/dashboard/antern-recruiter/profile" 
                          onClick={() => setProfileDropdownOpen(false)}
