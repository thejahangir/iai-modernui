...
const navItems: NavItem[] = [
  ...
  { title: "My Profile", href: "/dashboard/candidate/profile", icon: UserCircle },
  { title: "Schedule Interview", href: "/dashboard/candidate/schedule", icon: Calendar },
  { title: "Apply Jobs", href: "/dashboard/candidate/apply", icon: Briefcase },
  { title: "Viewed Profiles", href: "/dashboard/candidate/viewed", icon: Eye },
];

const mockNotifications = [
  { id: 1, title: "Interview Scheduled", message: "Your interview for Frontend Engineer is confirmed.", time: "10m ago", read: false },
  { id: 2, title: "Profile Viewed", message: "Your profile was viewed by Google HR.", time: "1h ago", read: false },
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="relative h-16 bg-white border-b border-border/50 flex items-center justify-between px-4 sm:px-6 z-40 shrink-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold font-heading hidden sm:block">Candidate Workspace</h1>
          </div>
                  ...
                  <>
                    ...
                    >
                      <div className="py-2">
                        ...
                        <Link 
                          to="/dashboard/candidate/change-password" 
                          onClick={() => setProfileDropdownOpen(false)}
                          className="flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-foreground hover:bg-secondary/50 transition-colors"
                        >
