...
const navItems: NavItem[] = [
  { title: "Dashboard", href: "/dashboard/superadmin", icon: LayoutDashboard },
  { title: "Password", href: "/dashboard/superadmin/password", icon: KeyRound },
  { title: "Add IAI User", href: "/dashboard/superadmin/add-iai-user", icon: UserPlus },
  { title: "Client Escalation", href: "/dashboard/superadmin/escalation", icon: AlertTriangle },
  {
    title: "Skills",
    icon: Code2,
    subItems: [
      { title: "Primary Skills", href: "/dashboard/superadmin/skills/primary", icon: Code2 },
      { title: "Secondary Skills", href: "/dashboard/superadmin/skills/secondary", icon: Code2 },
    ],
  },
  {
    title: "Interviews",
    icon: Video,
    subItems: [
      { title: "Interviews", href: "/dashboard/superadmin/interviews", icon: Video },
      { title: "Edit Rating", href: "/dashboard/superadmin/interviews/rating", icon: Star },
    ],
  },
  {
    title: "Candidate",
    icon: UserCheck,
    subItems: [
      { title: "ByPass Payment Gateways", href: "/dashboard/superadmin/candidate/bypass", icon: CreditCard },
      { title: "Registered Candidate", href: "/dashboard/superadmin/candidate/registered", icon: UserCheck },
    ],
  },
  {
    title: "Interviewer",
    icon: Users,
    subItems: [
      { title: "Interview Schedules", href: "/dashboard/superadmin/interviewer/schedules", icon: Calendar },
      { title: "Registered Interviewers", href: "/dashboard/superadmin/interviewer/registered", icon: Users },
    ],
  },
  {
    title: "Company",
    icon: Building2,
    subItems: [
      { title: "Add Profiles", href: "/dashboard/superadmin/company/add", icon: PlusCircle },
      { title: "All Profiles", href: "/dashboard/superadmin/company/all", icon: List },
      { title: "Post Job", href: "/dashboard/superadmin/company/post", icon: Building2 },
      { title: "View Rating", href: "/dashboard/superadmin/company/rating", icon: Star },
      { title: "Company OnBoard", href: "/dashboard/superadmin/company/onboard", icon: UserPlus },
      { title: "Profiles Dashboard", href: "/dashboard/superadmin/company/profiles", icon: LayoutDashboard },
      { title: "Release Candidates", href: "/dashboard/superadmin/company/release", icon: UserMinus },
    ],
  },
  { title: "Todays Follow-ups", href: "/dashboard/superadmin/follow-ups", icon: CalendarCheck },
  { title: "City", href: "/dashboard/superadmin/city", icon: MapPin },
];
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="relative h-16 bg-white border-b border-border/50 flex items-center justify-between px-4 sm:px-6 z-40 shrink-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold font-heading hidden sm:block">SuperAdmin Workspace</h1>
          </div>
                  ...
                  <>
                    ...
                    >
                      <div className="py-2">
                        ...
                        <Link 
                          to="/dashboard/superadmin/change-password" 
                          onClick={() => setProfileDropdownOpen(false)}
                          className="flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-foreground hover:bg-secondary/50 transition-colors"
                        >
