...
const navItems: NavItem[] = [
  { title: "Dashboard", href: "/dashboard/vendor", icon: LayoutDashboard },
  { title: "All Posting", href: "/dashboard/vendor/postings", icon: FileText },
  { title: "Vendor User", href: "/dashboard/vendor/users", icon: User },
  { title: "All Profile", href: "/dashboard/vendor/profiles", icon: Users },
];

const mockNotifications = [
  { id: 1, title: "New Requirement", message: "A new job requirement has been posted.", time: "10m ago", read: false },
  { id: 2, title: "Candidate Selected", message: "Your candidate has been selected for interview.", time: "1h ago", read: false },
];

export default function VendorLayout() {
  const [sidebarOpen, setSidebarOpen] = useState(false);
  const [companyLogo, setCompanyLogo] = useState("https://upload.wikimedia.org/wikipedia/commons/f/f1/Vitejs-logo.svg");
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="relative h-16 bg-white border-b border-border/50 flex items-center justify-between px-4 sm:px-6 z-40 shrink-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold font-heading hidden sm:block">Vendor Workspace</h1>
          </div>
