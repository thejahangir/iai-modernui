...
const navItems: NavItem[] = [
  { title: "Dashboard", href: "/dashboard/vendor-recruiter", icon: LayoutDashboard },
  { title: "All Posting", href: "/dashboard/vendor-recruiter/postings", icon: FileSpreadsheet },
  { title: "All Profile", href: "/dashboard/vendor-recruiter/profiles", icon: Users },
];

const mockNotifications = [
  { id: 1, title: "System Update", message: "Global settings have been updated.", time: "10m ago", read: false },
  { id: 2, title: "New Admin Registered", message: "A new admin user has been created.", time: "1h ago", read: false },
];

export default function VendorRecruiterLayout() {
  const [sidebarOpen, setSidebarOpen] = useState(false);
  const [companyLogo, setCompanyLogo] = useState("https://upload.wikimedia.org/wikipedia/commons/d/d5/Tailwind_CSS_Logo.svg");
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="relative h-16 bg-white border-b border-border/50 flex items-center justify-between px-4 sm:px-6 z-40 shrink-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold font-heading hidden sm:block">Vendor Recruiter Workspace</h1>
          </div>
                ...
                {profileDropdownOpen && (
                  <>
                    ...
                    >
                      <div className="py-2">
                        <Link 
                          to="/dashboard/vendor-recruiter/profile" 
                          onClick={() => setProfileDropdownOpen(false)}
