      ...
      <div className="hidden lg:flex w-1/2 relative bg-primary/5 items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 p-12 max-w-2xl text-center">
          ...
          >
            ...
            <img 
              src="https://images.unsplash.com/photo-1516383740770-fbcc5ccbece0?ixlib=rb-4.0.3&auto=format&fit=crop&w=1769&q=80" 
              alt="Secure Access" 
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              Get back to managing your interviews quickly and securely.
            </p>
          </motion.div>
        </div>
      </div>
