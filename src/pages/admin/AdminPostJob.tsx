                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-center gap-2">
                      <JobActionMenu 
                        ...
                        onInterviewProcess={(job) => { navigate("/dashboard/admin/company/interview-process"); }}
                      />
                    </div>
                  </td>
                </tr>
                    ...
                    <tbody className="divide-y divide-border/50">
                      {addedVendors.map((vendor) => (
                        <tr key={vendor.id} className="hover:bg-primary/5 transition-colors">
                          ...
                          <JobActionMenu 
                            item={item} 
                            onView={() => { setSelectedJob(item); setShowViewModal(true); }} 
                            onEdit={handleEditJob}
                            onAddVendor={(item) => { setVendorJob(item); setShowVendorModal(true); }}
                            onEscalation={(item) => { setEscalationJob(item); setShowEscalationModal(true); }}
                            onInterviewProcess={() => { navigate("/dashboard/admin/company/interview-process"); }}
                          />
                            <button 
