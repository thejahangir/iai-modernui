...
export default function AnternClientAllPostings() {
        ...
        <AnimatePresence>
          {paginatedPostings.map((posting, idx) => (
            ...
            >
              ...
              <div className="p-5 flex-1 flex flex-col space-y-4">
                ...
                <div className="pt-1 mt-auto">
                  <button 
                    ...
                    className="w-full flex items-center justify-center gap-1.5 py-2 bg-rose-50 text-rose-600 hover:bg-rose-100 border border-rose-100 rounded-lg text-sm font-bold transition-colors"
                  >
              ...
              {/* Card Footer (Metrics) */}
              <div className="bg-slate-50/80 px-4 py-3 border-t border-slate-100 grid grid-cols-3 gap-2 divide-x divide-slate-200">
