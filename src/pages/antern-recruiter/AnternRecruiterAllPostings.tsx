...
export default function AnternRecruiterAllPostings() {
        ...
        <AnimatePresence>
          {paginatedPostings.map((posting, idx) => (
            ...
            >
              ...
              <div className="p-5 flex-1 flex flex-col space-y-4">
                ...
                <div className="pt-2 mt-auto grid grid-cols-2 gap-2">
                  ...
                  <button 
                    ...
                    className="w-full flex items-center justify-center gap-1.5 py-2 bg-rose-50 text-rose-600 hover:bg-rose-100 border border-rose-100 rounded-lg text-[11px] sm:text-xs font-bold transition-colors"
                  >
              ...
              <div className="bg-slate-50/80 border-t border-slate-100 flex flex-col">
                <div className="px-4 py-3 grid grid-cols-3 gap-2 divide-x divide-slate-200">
                  ...
                  <div className="text-center flex flex-col justify-center">
                    ...
                    <p className="text-[9px] font-bold text-slate-500 uppercase tracking-wider line-clamp-1">Applied Candidate</p>
                  </div>
                  <div className="text-center flex flex-col justify-center">
                    <div className="flex items-center justify-center gap-1 mb-0.5">
