...
const MOCK_DESIGNATIONS_LIST = [
  ...
  { label: "System Architect", value: "System Architect" },
  { label: "Business Analyst", value: "Business Analyst" }
];

const initialData = [
  { id: "1", name: "Software Engineer", description: "Responsible for developing and maintaining software applications." },
  { id: "2", name: "Senior Software Engineer", description: "Leads technical design and mentors junior developers in the team." },
  { id: "3", name: "Project Manager", description: "Oversees project timelines, resources, and deliverables across teams." },
  { id: "4", name: "QA Engineer", description: "Ensures software quality through manual and automated testing." },
  { id: "5", name: "DevOps Engineer", description: "Manages infrastructure, deployments, and CI/CD pipelines." },
  { id: "6", name: "Product Manager", description: "Defines product vision, strategy, and roadmap." },
  { id: "7", name: "UX Designer", description: "Designs user interfaces and improves user experience." },
  { id: "8", name: "Data Scientist", description: "Analyzes complex data to help make business decisions." },
  { id: "9", name: "System Architect", description: "Designs high-level system architecture and technology stack." },
  { id: "10", name: "Business Analyst", description: "Bridges the gap between IT and the business using data analytics." }
];

export default function AnternRecruiterDesignation() {
  ...
  const handleSearch = () => {
    ...
    if (filterDesignation) {
      filtered = filtered.filter(item => item.name === filterDesignation);
    }
  ...
  const handleDelete = (id: string) => {
    if(confirm("Are you sure you want to delete this designation?")) {
      ...
      if (filterDesignation) {
        newFiltered = newFiltered.filter(item => item.name === filterDesignation);
      }
  ...
  return (
    <div className="space-y-6 relative">
      <div>
        <h2 className="text-3xl font-bold font-heading text-foreground tracking-tight">Designations</h2>
        <p className="text-muted-foreground mt-1">Manage all available job designations and titles.</p>
      </div>
      ...
      >
        ...
        <div className="flex flex-wrap md:flex-nowrap items-center gap-3 w-full xl:w-auto">
          <SearchableSelect 
            options={MOCK_DESIGNATIONS_LIST} 
        ...
        >
          ...
          {paginatedData.length === 0 && (
            <div className="col-span-full py-16 flex flex-col items-center justify-center text-muted-foreground bg-white rounded-2xl border border-border/50">
              ...
              <p className="font-bold text-foreground text-lg">No designations found</p>
              <p className="text-sm mt-1 max-w-[300px] text-center">Click the "Add Designation" button to create one, or adjust your search filters.</p>
            </div>
          )}
        </motion.div>
      ) : (
        ...
        >
          <div className="overflow-x-auto">
            ...
            <thead className="text-xs text-muted-foreground uppercase bg-secondary/50 border-b border-border/50">
              <tr>
                <th className="px-6 py-4 font-bold">Designation Name</th>
                ...
                <tr>
                  <td colSpan={3} className="px-6 py-12 text-center text-muted-foreground">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="font-bold text-foreground">No designations found</p>
                      <p className="text-sm mt-1">Click the "Add Designation" button to create one.</p>
                    </div>
                  </td>
                </tr>
              )}
            ...
            >
              <div className="flex items-center justify-between p-6 border-b border-border/50 shrink-0">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-foreground">{editingId ? "Edit Designation" : "Add New Designation"}</h3>
                    <p className="text-sm text-muted-foreground mt-0.5">{editingId ? "Update the details for this designation" : "Fill in the details to add a new designation"}</p>
                  </div>
                </div>
                <button 
                  onClick={() => setShowAddModal(false)}
              ...
              <div className="p-6 overflow-y-auto flex-1 space-y-6">
                <div className="space-y-6">
                  <div className="relative mt-2">
                    <div className="absolute -top-2 left-3 bg-white px-1 text-[10px] font-bold text-muted-foreground z-10">Designation Name *</div>
                    <input 
                      type="text" 
                      value={addName}
