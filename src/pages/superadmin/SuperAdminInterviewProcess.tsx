...
export default function SuperAdminInterviewProcess() {
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
            <button onClick={() => navigate("/dashboard/admin/company/post")} className="hover:text-primary transition-colors">Post Job</button>
