...
import { Search, RotateCcw, Download, Eye, CalendarClock, Pencil, History, X, Video, AlertCircle, Clock, CheckCircle2, FileText, User, Copy, ChevronLeft, ChevronRight } from "lucide-react";
...
const initialData = [
  ...
  { 
    id: "INT-1003", date: "2026-06-27", name: "Vikram Malhotra", email: "vikram@example.com", mobile: "+1 555-0303", interviewer: "Aarohi Patel", primarySkill: "React", rating: "4.0/5", company: "Infosys", recruiter: "Rahul Joshi", designation: "Frontend Engineer", status: "Completed", isScheduled: true, adminName: "Neha Mehta", meetingLink: ""
  },
  { 
    id: "INT-1004", date: "2026-06-28", name: "Ananya Desai", email: "ananya@example.com", mobile: "+1 555-0404", interviewer: "Amit Kumar", primarySkill: "Node.js", rating: "Pending", company: "Wipro", recruiter: "Aarohi Patel", designation: "Backend Engineer", status: "Scheduled", isScheduled: true, adminName: "Neha Mehta", meetingLink: "https://zoom.us/j/987654321"
  },
  { 
    id: "INT-1005", date: "2026-06-29", name: "Chandan Das", email: "chandan@example.com", mobile: "+1 555-0505", interviewer: "Aarohi Patel", primarySkill: "React", rating: "5.0/5", company: "TCS", recruiter: "Rahul Joshi", designation: "Senior Engineer", status: "Completed", isScheduled: true, adminName: "Neha Mehta", meetingLink: ""
  },
  { 
    id: "INT-1006", date: "2026-06-30", name: "Aditya Singh", email: "aditya@example.com", mobile: "+1 555-0606", interviewer: "Amit Kumar", primarySkill: "Node.js", rating: "Pending", company: "Infosys", recruiter: "Aarohi Patel", designation: "Backend Developer", status: "Pending", isScheduled: false, adminName: "Neha Mehta", meetingLink: ""
  },
  { 
    id: "INT-1007", date: "2026-07-01", name: "Meera Reddy", email: "meera@example.com", mobile: "+1 555-0707", interviewer: "Aarohi Patel", primarySkill: "React", rating: "3.5/5", company: "Wipro", recruiter: "Rahul Joshi", designation: "UI Developer", status: "Completed", isScheduled: true, adminName: "Neha Mehta", meetingLink: ""
  },
  { 
    id: "INT-1008", date: "2026-07-02", name: "Rohan Kapoor", email: "rohan.k@example.com", mobile: "+1 555-0808", interviewer: "Amit Kumar", primarySkill: "Node.js", rating: "4.5/5", company: "TCS", recruiter: "Aarohi Patel", designation: "Lead Engineer", status: "Scheduled", isScheduled: true, adminName: "Neha Mehta", meetingLink: "https://zoom.us/j/111222333"
  },
];
...
export default function SuperAdminInterviews() {
  ...
  const filteredData = useMemo(() => {
    return data.filter(item => {
      ...
      if (appliedFilters.primarySkill) {
         const skill = mockSkills.find(s => s.id === appliedFilters.primarySkill)?.name;
         if (item.primarySkill !== skill) return false;
      }
      
      if (appliedFilters.interviewer) {
         const interviewer = mockInterviewers.find(i => i.id === appliedFilters.interviewer)?.name;
         if (item.interviewer !== interviewer) return false;
      }
      
      if (appliedFilters.registeredOnly && !item.isScheduled) return false;
      if (appliedFilters.ratedOnly && item.rating === "Pending") return false;
  ...
  const handleReset = () => {
    const defaultFilters = { startDate: "", endDate: "", primarySkill: "", interviewer: "", location: "", registeredOnly: false, ratedOnly: false };
